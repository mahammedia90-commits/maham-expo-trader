...
const expos: Expo[] = [
  {
    id: "expo-001",
    nameAr: "ليالي رمضان في كافد KAFD",
    nameEn: "Ramadan Nights at KAFD",
    descAr: "فعالية رمضانية مميزة في ساحة الوادي بمركز الملك عبدالله المالي — أكشاك طعام ومشروبات وترفيه يومياً من 5 مساءً حتى 2 صباحاً",
    descEn: "Premium Ramadan experience at KAFD Al Wadi Square — F&B kiosks, entertainment, daily 5 PM – 2 AM",
    category: "event",
    cityAr: "الرياض",
    cityEn: "Riyadh",
    venue: "KAFD — Al Wadi Square",
    ...
    featured: true,
    aiRecommended: true,
    organizer: "Maham Expo + KAFD",
    tags: ["رمضان", "أغذية", "ترفيه"],
  },
  {
    id: "expo-002",
    nameAr: "فعالية عيد الفطر في كافد KAFD",
    nameEn: "Eid Al-Fitr Activation at KAFD",
    descAr: "احتفالية عيد الفطر المبارك في ساحة الوادي — عروض حية وأكشاك طعام ومناطق ترفيهية للعائلات",
    descEn: "Eid Al-Fitr celebration at Al Wadi Square — live shows, F&B kiosks, family entertainment zones",
    category: "festival",
    cityAr: "الرياض",
    cityEn: "Riyadh",
    venue: "KAFD — Al Wadi Square",
    ...
    priceTo: 35000,
    rating: 4.8,
    visitors: "30,000 – 60,000",
    image: CONFERENCE,
    featured: true,
    aiRecommended: true,
    organizer: "Maham Expo + KAFD",
    tags: ["عيد", "ترفيه", "عائلات"],
  },
  {
    id: "expo-003",
    nameAr: "مهرجان الطعام KAFD Time Out Food Festival",
    nameEn: "KAFD Time Out Food Festival",
    descAr: "مهرجان الطعام الأكبر في الرياض بالتعاون مع Time Out — أكثر من 100 علامة تجارية محلية ودولية",
    descEn: "Riyadh's largest food festival in partnership with Time Out — 100+ local & international brands",
    category: "exhibition",
    cityAr: "الرياض",
    cityEn: "Riyadh",
    venue: "KAFD — Al Wadi Square",
  ...
  {
    id: "expo-004",
    nameAr: "موسم الرياض — بوليفارد وورلد",
    nameEn: "Riyadh Season — Boulevard World",
    descAr: "أكبر فعالية ترفيهية في الشرق الأوسط تضم مناطق ترفيهية ومطاعم ومحلات تجارية من جميع أنحاء العالم — موسم تشغيلي 6 أشهر",
    descEn: "The largest entertainment destination in the Middle East — global dining, retail & entertainment — 6-month operational season",
    category: "festival",
    cityAr: "الرياض",
    cityEn: "Riyadh",
    venue: "بوليفارد وورلد — موسم الرياض",
  ...
  {
    id: "expo-005",
    nameAr: "مشروع على خطاه — Ala Khutah Project",
    nameEn: "Ala Khutah Project — On His Steps",
    descAr: "مشروع تشغيل مواقع البيع بالتجزئة والأغذية والمشروبات ضمن موسم الرياض — عقود تشغيل مباشرة",
    descEn: "Retail & F&B site operations within Riyadh Season — direct operational contracts with revenue sharing",
    category: "event",
    cityAr: "الرياض",
    cityEn: "Riyadh",
    venue: "مشروع على خطاه — موسم الرياض",
    ...
    featured: false,
    aiRecommended: true,
    organizer: "Maham Expo + One May",
    tags: ["تجزئة", "أغذية", "موسم الرياض"],
  },
  {
    id: "expo-006",
    nameAr: "معرض الفنون والثقافة في كافد KAFD",
    nameEn: "KAFD Art Shows & Cultural Parades",
    descAr: "معارض فنية وعروض ثقافية في المساحات العامة لمركز الملك عبدالله المالي — طوال 2026",
    descEn: "Art exhibitions & cultural parades across KAFD public spaces — throughout 2026",
    category: "exhibition",
    cityAr: "الرياض",
    cityEn: "Riyadh",
    venue: "KAFD Public Spaces",
